...
-(UIToolbar *)setToolbarStyle{
    ...
    UIBarButtonItem *lefttem=[[UIBarButtonItem alloc] initWithTitle:LOCALIZATION(@"btn_cancel") style:UIBarButtonItemStylePlain target:self action:@selector(remove)];
    
    UIBarButtonItem *centerSpace=[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:self action:nil];
    
    UIBarButtonItem *right=[[UIBarButtonItem alloc] initWithTitle:LOCALIZATION(@"btn_confirm") style:UIBarButtonItemStylePlain target:self action:@selector(doneClick)];
