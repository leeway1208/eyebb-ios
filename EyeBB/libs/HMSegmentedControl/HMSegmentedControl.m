        ...
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            // Text inside the CATextLayer will appear blurry unless the rect values are rounded
             if([self.sectionTitles count]==3){
                 CGFloat y = roundf(((CGRectGetHeight(self.frame) - self.selectionIndicatorHeight) / 2) + (self.selectionIndicatorHeight - stringHeight / 2))-3;
            ...
            //------------------------
            if([self.sectionTitles count]==3){
//            UILabel *lineLabelOne = [[UILabel alloc]initWithFrame:CGRectMake(320/3, 0, 1, 44)];
//            lineLabelOne.backgroundColor = [UIColor whiteColor];
//            [self.scrollView addSubview:lineLabelOne];
//            UILabel *lineLabelTwo = [[UILabel alloc]initWithFrame:CGRectMake(320/3*2, 0, 1, 44)];
//            lineLabelTwo.backgroundColor = [UIColor whiteColor];
//            [self.scrollView addSubview:lineLabelTwo];
            }
            if([self.sectionTitles count]==4){
                UILabel *lineLabelOne = [[UILabel alloc]initWithFrame:CGRectMake(320/4, 5, 1, 34)];
                lineLabelOne.backgroundColor = [UIColor colorWithRed:0.565 green:0.612 blue:0.698 alpha:1];
                [self.scrollView addSubview:lineLabelOne];
                UILabel *lineLabelTwo = [[UILabel alloc]initWithFrame:CGRectMake(320/4*3, 5, 1, 34)];
                lineLabelTwo.backgroundColor = [UIColor colorWithRed:0.565 green:0.612 blue:0.698 alpha:1];
                [self.scrollView addSubview:lineLabelTwo];
                UILabel *lineLabelThree = [[UILabel alloc]initWithFrame:CGRectMake(320/4*2, 5, 1, 34)];
                lineLabelThree.backgroundColor = [UIColor colorWithRed:0.565 green:0.612 blue:0.698 alpha:1];
                [self.scrollView addSubview:lineLabelThree];
            }
