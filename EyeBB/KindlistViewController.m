    ...
    if (cell == nil) {
        ...
        if (indexPath.row==0) {
            ...
            else
            {
                ...
                for (int i=0; i<4; i++) {
                    ...
                    kindBtn.frame=CGRectMake(10+((CGRectGetWidth(bindView.frame)-100)/5+20)*i,25+((CGRectGetWidth(bindView.frame)-100)/5+20)*sNum , (CGRectGetWidth(cell.frame)-100)/5, (CGRectGetWidth(cell.frame)-100)/5);
        ...
        else if(indexPath.row==1)
        {
            if ([cell viewWithTag:1000001]==nil) {
                ...
                for (int i=0; i<10; i++) {
                    //房间图标
                    UIButton * kindBtn=[[UIButton alloc] initWithFrame:CGRectMake(10+((CGRectGetWidth(bindView.frame)-100)/5+20)*i,25 , (CGRectGetWidth(cell.frame)-100)/5, (CGRectGetWidth(cell.frame)-100)/5)];
                    [kindBtn.layer setCornerRadius:CGRectGetHeight([kindBtn bounds]) / 2];
                    [kindBtn.layer setMasksToBounds:YES];
                    [kindBtn.layer setBorderWidth:2];
        ...
        else if(indexPath.row==2)
        {
            if ([cell viewWithTag:2000001]==nil) {
                ...
                [bindView setBackgroundColor:[UIColor colorWithRed:0.965 green:0.847 blue:0.243 alpha:1]];
                //设置按钮是否圆角
                [bindView.layer setMasksToBounds:YES];
                //圆角像素化
                [bindView.layer setCornerRadius:4.0];
